...
export default function HeroSection(props: DetailedHTMLProps<HTMLAttributes<HTMLElement>, HTMLElement>): ReactElement {
				...
				>
					...
					<span className="relative md:whitespace-nowrap">
						{/* <svg
							aria-hidden="true"
							viewBox="0 0 418 42"
							className="absolute left-0 top-2/3 h-[0.38em] w-full fill-violet-300/70 sm:h-[0.58em]"
						...
						<span
							className="relative mx-2 text-indigo-600 lg:mx-4"
							// style={{
							// 	backgroundImage: "linear-gradient(to left, #4338ca, #1d4ed8 )",
							// 	color: "transparent",
							// 	backgroundClip: "text",
							// }}
						>
