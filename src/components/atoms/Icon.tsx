...
export interface IconProps extends SVGProps<SVGSVGElement> {
	type: "house" | "chevron-up" | "chevron-down" | "analytics" | "engagement" | "security" | "integrations" | "automations" | "video" | "phone";
}
...
export const Icon = (props: IconProps): ReactElement => {
	switch (props.type) {
		case "house":
			return (
				<svg {...props} xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-hidden="true" data-slot="icon" viewBox="0 0 576 512">
