...
export const Banks = (): ReactElement => {
	...
	return (
		...
		<div className="banks group mt-28 rounded-2xl border border-white/50 bg-white/5 bg-clip-padding py-6 shadow-2xl shadow-blue-400/5 backdrop-blur-md transition-all duration-700 hover:border-white/80 hover:bg-white/35 hover:shadow-2xl hover:shadow-blue-800/10 lg:mt-24 lg:rounded-3xl lg:hover:px-4">
